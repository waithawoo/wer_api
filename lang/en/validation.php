    ...
    */
    ...
    'custom' => [
        ...
        'phone' => [
            ...
            'regex' => 'The phone number format is invalid. Please use numbers, spaces, dashes, plus, and parentheses.',
            'min' => 'The phone number must be at least :min digits.',
        ],
        'photo' => [
            'required' => 'The photo is required.',
            'string' => 'The photo must be a string.',
            'base64_image' => 'The photo must be a valid base64-encoded image.',
        ],
        'email' => [
            'required' => 'Email address is required.',
            'email' => 'This is not a valid email address format.',
            'unique' => 'The email address is already in use.',
            'exists' => 'The specified email address does not exist.',
        ],
        'password' => [
        ...
        'confirm_password' => [
            ...
            'same' => 'The confirm password must match the password.',
        ],
        'token' => [
